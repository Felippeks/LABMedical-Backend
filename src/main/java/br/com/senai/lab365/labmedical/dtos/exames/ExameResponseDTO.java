...
public class ExameResponseDTO {
    ...
    public ExameResponseDTO(Long id, String nomeExame, LocalDate dataExame, LocalTime horarioExame, String tipoExame, String laboratorio, String urlDocumento, String resultados, Long pacienteId) {
        this.id = id;
